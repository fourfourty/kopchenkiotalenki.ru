    ...
    <section className="page-d">
      ...
      <div className="page-d__contacts contacts">
        ...
        <a href="https://api.whatsapp.com/send?phone=<+79407100626>"  rel="noreferrer" className="icons__link" target="_blank">
          ...
          <a href="https://www.instagram.com/kopchenki.ot.alenki/" rel="noreferrer" className="icons__link" target="_blank">
          <Icons 
          name={'instagram'}
          color={'#fff'}
          size={'20px'}
          className={'icons__icon'}
          />  
            <span className="icons__discript">kopchenki.u.alenki</span>
          </a>
        </div>
      </div>
